...
export const Form: React.FC<Props> = () => (
  <section className="relative bg-white" aria-labelledby="contactHeading">
    ...
    <div className="relative px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
      <svg
        className="absolute top-0 right-0 transform translate-x-1/2 -translate-y-16 sm:translate-x-1/4 md:-translate-y-24 lg:-translate-y-72"
        width="404"
        height="384"
        fill="none"
        viewBox="0 0 404 384"
    ...
    <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
      <div className="relative overflow-hidden bg-white rounded-lg shadow-xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3">
          <div className="relative px-6 py-10 overflow-hidden bg-gradient-to-b from-green-500 to-green-600 sm:px-10 xl:p-12">
            <div
            ...
            <p className="max-w-3xl mt-6 text-base text-green-50">
          ...
          <div className="px-6 py-10 sm:px-10 lg:col-span-2 xl:p-12">
            ...
            >
              <div>
                ...
                <div className="mt-1">
                  <input
                    ...
                    className="block w-full px-4 py-3 rounded-md shadow-sm text-warm-gray-900 focus:ring-green-500 focus:border-green-500 border-warm-gray-300"
                  />
                </div>
              </div>
              <div>
              ...
              <div className="sm:col-span-2 sm:flex sm:justify-end">
                <button
                  type="submit"
                  className="inline-flex items-center justify-center w-full px-6 py-3 mt-2 text-base font-medium text-white bg-green-500 border border-transparent rounded-md shadow-sm hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 sm:w-auto"
                >
                  Submit
                </button>
              </div>
