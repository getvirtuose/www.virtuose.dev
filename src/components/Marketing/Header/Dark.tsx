  ...
  return (
    <div className="relative">
      <button
        ...
        className={`inline-flex items-center text-base font-medium text-white hover:text-gray-300 rounded-md group focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 ${
          isOpen ? "text-white" : ""
        }`}
        aria-expanded="false"
      >
        ...
        <SvgChevronDown
          className={`w-5 h-5 ml-2 text-white group-hover:text-gray-300 transform ${
            isOpen ? "rotate-180" : ""
          }`}
        />
      </button>
      ...
      <Transition
        show={isOpen}
        className="absolute z-10 w-screen max-w-md mt-3 -ml-4 transform lg:max-w-2xl lg:-ml-10"
...
export const Dark: React.FC<Props> = () => {
      ...
      <div className="relative bg-gray-900">
        <div className="flex items-center justify-between px-4 py-6 mx-auto max-w-7xl sm:px-6 md:justify-start md:space-x-10 lg:px-8">
          ...
          <nav className="hidden space-x-10 md:flex">
            <Tab to="/feature/">
              <FormattedMessage id="landing/tabs/features" />
            </Tab>
            ...
            <Tab to="/contact/">
              <FormattedMessage id="landing/tabs/contact" />
            </Tab>
          </nav>
          <div className="items-center justify-end hidden space-x-8 md:flex md:flex-1 lg:w-0">
            <Link
              to="/signin/"
              className="text-base font-medium text-white hover:text-gray-300 whitespace-nowrap"
            >
            ...
            <Link
              to="/signup/"
              className="inline-flex items-center px-4 py-2 text-base font-medium text-white bg-green-600 border border-transparent rounded-md hover:bg-gray-700"
            >
